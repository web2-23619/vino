...
<template id="favoriteBottle">
	<article class="card_bottle" data-js-id="" data-js-Name="">
		...
		<section>
			...
			<button href="{{ route('search.index', ['source' => 'cellier']) }}" class="btn btn_semi_accent btn_cellar" data-js-action="moveToCellar">Envoyer vers le cellier</button>
			<button href="{{ route('search.index', ['source' => 'listeAchat']) }}" class="btn btn_semi_accent btn_cellar" data-js-action="moveToPurchaseList">Ajouter à la liste d'achat</button>
		</section>
	</article>
</template>
